...
{
	APRS_API_RegisterGlobalFunction(aprs_is_init);
	APRS_API_RegisterGlobalFunction(aprs_is_deinit);
	APRS_API_RegisterGlobalFunction(aprs_is_is_blocking);
	APRS_API_RegisterGlobalFunction(aprs_is_is_connected);
	APRS_API_RegisterGlobalFunction(aprs_is_connect);
	APRS_API_RegisterGlobalFunction(aprs_is_disconnect);
	APRS_API_RegisterGlobalFunction(aprs_is_read_packet);
	...
	APRS_API_RegisterGlobalFunction(aprs_packet_init);
	APRS_API_RegisterGlobalFunction(aprs_packet_deinit);
	APRS_API_RegisterGlobalFunction(aprs_packet_get_igate);
	APRS_API_RegisterGlobalFunction(aprs_packet_set_igate);
	APRS_API_RegisterGlobalFunction(aprs_packet_get_qflag);
	APRS_API_RegisterGlobalFunction(aprs_packet_set_qflag);
	APRS_API_RegisterGlobalFunction(aprs_packet_get_tocall);
	APRS_API_RegisterGlobalFunction(aprs_packet_set_tocall);
	APRS_API_RegisterGlobalFunction(aprs_packet_get_sender);
	APRS_API_RegisterGlobalFunction(aprs_packet_set_sender);
	APRS_API_RegisterGlobalFunction(aprs_packet_get_content);
	APRS_API_RegisterGlobalFunction(aprs_packet_set_content);
	APRS_API_RegisterGlobalFunction(aprs_packet_get_digipath);
	APRS_API_RegisterGlobalFunction(aprs_packet_set_digipath);

	APRS_API_RegisterGlobalFunction(aprs_message_init);
	APRS_API_RegisterGlobalFunction(aprs_message_decode);
	APRS_API_RegisterGlobalFunction(aprs_message_deinit);
	APRS_API_RegisterGlobalFunction(aprs_message_get_ack);
	APRS_API_RegisterGlobalFunction(aprs_message_set_ack);
	APRS_API_RegisterGlobalFunction(aprs_message_get_content);
	APRS_API_RegisterGlobalFunction(aprs_message_set_content);
	APRS_API_RegisterGlobalFunction(aprs_message_get_destination);
	APRS_API_RegisterGlobalFunction(aprs_message_set_destination);

	APRS_API_RegisterGlobalFunction(aprs_position_init);
	APRS_API_RegisterGlobalFunction(aprs_position_decode);
	APRS_API_RegisterGlobalFunction(aprs_position_deinit);
	APRS_API_RegisterGlobalFunction(aprs_position_get_altitude);
	APRS_API_RegisterGlobalFunction(aprs_position_set_altitude);
	APRS_API_RegisterGlobalFunction(aprs_position_get_latitude);
	APRS_API_RegisterGlobalFunction(aprs_position_set_latitude);
	APRS_API_RegisterGlobalFunction(aprs_position_get_longitude);
	APRS_API_RegisterGlobalFunction(aprs_position_set_longitude);
	APRS_API_RegisterGlobalFunction(aprs_position_get_symbol_table);
	APRS_API_RegisterGlobalFunction(aprs_position_set_symbol_table);
	APRS_API_RegisterGlobalFunction(aprs_position_get_symbol_table_key);
	APRS_API_RegisterGlobalFunction(aprs_position_set_symbol_table_key);
}
