...
if FireWatch.Init('N0CALL', 0, 'WIDE1-1', 'noam.aprs2.net', 14580, 'FireWatch.db') then
	...
	FireWatch.Events.RegisterEvent(FireWatch.Events.OnStationEnteredFireZone, function(fire_id, fire_name, station, station_latitude, station_longitude, station_altitude, station_comment, station_distance_to_nearest_fire_hotspot, station_distance_to_nearest_fire_hotspot_elevation)
		Console.WriteLine(nil, string.format('Station %s has entered fire #%u zone. [Fire: %s, Distance: %.2f (+%.2f) ft]', station, fire_id, fire_name, station_distance_to_nearest_fire_hotspot, station_distance_to_nearest_fire_hotspot_elevation));
	end);
	...
	FireWatch.Events.RegisterEvent(FireWatch.Events.OnStationPositionChangedInFireZone, function(fire_id, fire_name, station, station_latitude, station_longitude, station_altitude, station_comment, station_distance_to_nearest_fire_hotspot, station_distance_to_nearest_fire_hotspot_elevation)
		Console.WriteLine(nil, string.format('Station %s has moved within fire #%u zone. [Fire: %s, Distance: %.2f (+%.2f) ft, Latitude: %.5f, Longitude: %.5f, Altitude: %.2f ft, Comment: %s]', station, fire_id, fire_name, station_distance_to_nearest_fire_hotspot, station_distance_to_nearest_fire_hotspot_elevation, station_latitude, station_longitude, station_altitude, station_comment));
	end);
